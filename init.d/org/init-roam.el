;;; init-roam.el --- Org-roam knowledge base -*- lexical-binding: t -*-
...
;  ("C-c n d" . org-roam-dailies-map)
 ...
 ^Org Dailies^
^^^^^^^──────────────────────────────────────
 ^View Date^          ^View Note^    ^Capture^
_d_: Today            _f_: Next      _n_: Today
_y_: Yesterday        _b_: Previous  _v_: Date
_t_: Tomorrow
_c_: Calendar
"
...
^^^^^^^──────────────────────────────────────
 ^Notes^            ^Modify^          ^Other^
_c_ Capture Roam    _t_ Add Tag       _u_ Open UI
_C_ Capture Org     _T_ Remove Tag    _D_ Sync DB
_f_ Find Roam       _I_ Import        _d_ Dailies
_i_ Insert          _C-c_ Create ID
"
        ("c" org-roam-capture)
        ("C" org-capture)
